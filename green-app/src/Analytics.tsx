...
{/*
            ...
            <div>
              ...
              <p><strong>Automobile Usage Pounds of CO2 equivalent:</strong> {Math.round(usageActivities.automobileusage * 0.88184905)} lbs of CO2</p>
              <p><strong>Food Waste Pounds of CO2 equivalent:</strong> {Math.round(usageActivities.foodwaste * 3.8)} lbs of CO2</p>
              <p><strong>Water Usage Pounds of CO2 equivalent:</strong> {Math.round(usageActivities.waterusage * .18)} lbs of CO2</p>
              <p><strong>Electricty Usage Pounds of CO2 equivalent:</strong> {Math.round(usageActivities.electricityusage * 2.07)} lbs of CO2</p>
              <p><strong>Flight Usage Pounds of CO2 equivalent:</strong> {Math.round(usageActivities.flightusage*.901)} lbs of CO2</p>
              <p><strong>Your Total CO2 equivalent:</strong> {Math.round(usageActivities.automobileusage * 0.88184905) + Math.round(usageActivities.foodwaste * 3.8) + Math.round(usageActivities.waterusage * .18) + Math.round(usageActivities.electricityusage * 2.07) + Math.round(usageActivities.flightusage*.901)} lbs of CO2</p>
            </div>
        */}
